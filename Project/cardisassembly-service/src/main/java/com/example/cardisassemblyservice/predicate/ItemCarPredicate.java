package com.example.cardisassemblyservice.predicate;

import com.example.cardisassemblyservice.domain.ItemCar;
import com.example.cardisassemblyservice.global.SearchCriteria;
import com.querydsl.core.types.dsl.BooleanExpression;
import com.querydsl.core.types.dsl.NumberPath;
import com.querydsl.core.types.dsl.PathBuilder;
import com.querydsl.core.types.dsl.StringPath;

public class ItemCarPredicate {

    private SearchCriteria criteria;

    public ItemCarPredicate(final SearchCriteria criteria) {
        this.criteria = criteria;
    }

    public BooleanExpression getPredicate() {
        final PathBuilder<ItemCar> entityPath = new PathBuilder<>(ItemCar.class, "itemCar");
