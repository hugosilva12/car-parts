...
public class AdvertisingPredicate {

    private SearchCriteria criteria;

    public AdvertisingPredicate(final SearchCriteria criteria) {
        this.criteria = criteria;
    }

    public BooleanExpression getPredicate() {
        final PathBuilder<Advertising> entityPath = new PathBuilder<>(Advertising.class, "car");
